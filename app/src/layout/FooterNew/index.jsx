      ...
      <div className="mx-auto flex-col sm:flex-row justify-center items-center flex sm:justify-between items-start px-[30px] lg:px-0 py-8 border-t border-[rgba(255,255,255,0.2)]">
        ...
        <div className="flex flex-col items-center sm:justify-between space-y-6 sm:items-end h-full">
          ...
          <div className="flex space-x-8 mb-4">
            <Link href="https://www.instagram.com/myperfectai/" className="hover:text-purple-400">
            ...
            <Link href="https://x.com/MyPerfectAI" className="hover:text-purple-400">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Youtube Icon */}
            <Link href="https://www.youtube.com/@MyPerfectAI" className="hover:text-purple-400">
              <FontAwesomeIcon icon={faYoutube} color="white" className="text-xl" />
            </Link>
          </div>
