    ...
    return (
        <Link href={`/blog-detail/${blog?.id}`}>
            <div className="bg-transparent rounded-lg">
                ...
                <h3 className="font-semibold text-lg text-white mb-2 line-clamp-2 lg:line-clamp-3 tracking-wide">{blog?.title}</h3>

                <p className="text-sm text-white mb-4 line-clamp-2 lg:line-clamp-3 tracking-wide">{blog?.description}</p>
                </div>
                ...
                <Link href={`/blog-detail/${blog?.id}`} className="flex justify-start items-center text-white mt-4 inline-block text-xs font-semibold">
