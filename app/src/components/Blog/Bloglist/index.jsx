...
const BlogList = () => {
    ...
    return (
        <section className="relative flex flex-col items-center justify-center min-w-screen min-h-screen pt-32 pb-16 text-white bg-no-repeat bg-[#181C1F] lg:bg-cover bg-[url('/images/mobileAllBg.png')] lg:bg-[url('/images/allPageBg.png')]">
            <div className="px-[30px] lg:px-[135px]">
                {/* Header Section */}
                <div className="text-center mb-4 lg:mb-16 flex flex-col justify-center items-center">
                ...
                {/* Blog Grid */}
                <div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px] lg:mt-[40px]">
                        <Image
