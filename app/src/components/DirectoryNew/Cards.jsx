...
function Cards() {
  return (
    <div className="relative bg-[#1e1e1e] border-[1px] border-gray-400 rounded-md flex flex-col min-h-[300px] text-center items-center p-6 min-h overflow-hidden">
      <div
        className="absolute"
        style={{
          width: '600px',
      ...
      ></div>
      <div className='absolute z-10 flex flex-col items-center justify-center w-full px-12'>
