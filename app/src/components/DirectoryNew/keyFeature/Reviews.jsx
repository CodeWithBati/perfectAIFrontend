...
export default function Reviews() {
  return (
    <section className="text-white">
      <h2 className="text-lg lg:text-2xl font-bold mb-5">Reviews</h2>
      <div className="lg:flex">
        <div className="lg:border-r lg:border-r-dashed pr-4" style={{ borderRightStyle: 'dashed' }}>
        ...
        <div className="lg:border-r lg:border-r-dashed pr-4 lg:ml-2 mt-4 lg:mt-0" style={{ borderRightStyle: 'dashed' }}>
          <div className="flex items-center mb-2">
        ...
        <div className="lg:ml-2 mt-4 lg:mt-0">
          <div className="flex items-center mb-2" style={{ borderRightStyle: 'dashed' }}>
            ...
            <span className="font-bold text-lg">Mixed</span>
          </div>
          <p className="text-sm">
