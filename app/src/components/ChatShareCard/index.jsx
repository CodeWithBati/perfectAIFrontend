    ...
    return (
        <Link href={`/chat/${chat?.id}`}>
            <div className="relative bg-[#323639] p-4 rounded-lg shadow-lg border border-[rgba(255,255,255,0.2)]">
                ...
                <button onClick={() => copyTextToClipboard(chat?.shareableLink)} className="bg-[#8B60B2] flex justify-center items-center text-base font-semibold text-white h-[38px] mt-[30px] rounded-[5px] px-[20px] py-[10px] hover:bg-[#763b9a] focus:outline-none focus:ring-2 focus:ring-[#8B60B2]">
