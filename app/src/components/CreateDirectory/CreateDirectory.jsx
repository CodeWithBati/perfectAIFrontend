  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-w-screen min-h-screen pt-32 pb-16 text-white bg-no-repeat bg-[#181C1F] lg:bg-cover bg-[url('/images/mobileSomeBg.png')] lg:bg-[url('/images/someBg.png')]">
      ...
      <div className="w-full lg:max-w-[570px] flex flex-col items-center justify-center px-[30px] lg:px-4 py-8">
        ...
        {/* Form */}
        <form className="w-full lg:w-[570px] space-y-4 flex justify-center items-center flex-col rounded-lg">
          ...
          <button className="bg-[#8B60B2] w-full lg:w-auto text-sm font-semibold text-white mt-8 rounded-[5px] px-[20px] py-[10px] hover:bg-[#763b9a] focus:outline-none focus:ring-2 focus:ring-[#8B60B2]">
            Create directory
          </button>
        </form>
      </div>
